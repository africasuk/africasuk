...
function DropdownMenuTrigger({
  ...
  return (
    <MenuPrimitive.Trigger
      ...
      className={cn(
        "inline-flex h-9 w-9 items-center justify-center rounded-md outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 focus-visible:ring-ring",
        className,
      )}
      {...props}
    />
