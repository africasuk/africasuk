  ...
  return (
    <div className="mb-8 border-b border-gray-200 pb-6">
      ...
      <p className="mt-3 max-w-2xl text-sm leading-7 text-gray-600 sm:text-base">
        Welcome to the AfricaSuk Help Center. We&apos;re here to make your shopping experience as simple and smooth as possible. Browse the topics below or contact our support team if you need further assistance.
      </p>
    </div>
  );
}