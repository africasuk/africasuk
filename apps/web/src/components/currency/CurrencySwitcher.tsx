...
const CURRENCIES = {
  USD: {
    ...
    renderFlag: () => (
      <svg
        className="h-3 w-4.5 rounded-xs object-cover shrink-0 shadow-3xs"
        viewBox="0 0 741 390"
      >
    ...
    renderFlag: () => (
      ...
      >
        ...
        <polygon
          ...
          fill="#eaaa00"
          transform="translate(-25, 0) scale(1.2) rotate(-15 135 275)"
        />
      </svg>
    ),
  },
...
export function CurrencySwitcher() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="group flex items-center gap-2 rounded-full border border-gray-100 bg-white px-3 py-1.5 text-left text-gray-700 hover:text-[#002b15] hover:border-gray-200 transition-all duration-200 focus:outline-none select-none cursor-pointer text-xs font-semibold shadow-xs min-w-22.5 xs:min-w-[105px]">
