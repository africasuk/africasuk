  ...
  return (
    <div className="mb-8 border-b border-gray-200 pb-6">
      ...
      <p className="mt-3 max-w-2xl text-sm leading-7 text-gray-600 sm:text-base">
        At AfricaSuk, customer satisfaction is important to us. Because many of our products are sourced internationally, our refund policy is designed to be fair to both our customers and our suppliers.
      </p>
    </div>
  );
}